defmodule BotArmyBriefingBot.Skills.Example do
  @moduledoc """
  Example skill for Briefing Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_briefing_bot.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_briefing_bot.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_briefing_bot/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_briefing_bot.command.example"
    ]
  end
